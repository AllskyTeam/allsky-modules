...
def gmailsend2(params, event):
    ...
    # Set the main body content initially
    msg.attach(MIMEText(messageBody, 'plain'))  # Plain text part
    ...
    # Update the main body content with the attachment details
