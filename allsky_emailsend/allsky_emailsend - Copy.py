...
metaData = {
    ...
    "argumentdetails": {        
        ...
        "image_selection": {
            ...
            "help": "Will only send if Allsky is configured to generate startrails and/or keogram.",
            "tab": "Daily Notification Setup",
            "type": {
                "fieldtype": "select",
...
def emailsend(params, event):
    ...
    max_attachment_size_mb = params['max_attachment_size_mb']
